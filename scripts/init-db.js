...
async function initializeDatabase() {
  try {
    ...
    await pool.query(`
      ...
      (3, 'Server-04', '00:1B:44:11:3A:D3', '172.16.0.3', 'Suspicious process detected', 'anomaly', '2025-03-05 11:18:42'),
      (3, 'Server-04', '00:1B:44:11:3A:D3', '172.16.0.3', 'System update completed', 'non-anomaly', '2025-03-10 15:33:17'),
      (3, 'Node-03', '00:1B:44:11:3A:D4', '172.16.0.4', 'Failed SSH attempts', 'anomaly', '2025-04-02 19:55:28'),
      (3, 'Node-03', '00:1B:44:11:3A:D4', '172.16.0.4', 'Firewall rules updated', 'non-anomaly', '2025-04-05 08:41:03'),
      (3, 'Server-05', '00:1B:44:11:3A:D5', '172.16.0.5', 'DDoS attack detected', 'anomaly', '2025-05-01 02:14:55'),
      (3, 'Server-05', '00:1B:44:11:3A:D5', '172.16.0.5', 'Backup completed', 'non-anomaly', '2025-05-05 23:59:59')
    `);
